...
portfolio = {
    ...
    "summary": {
        ...
        "text": "Intelligence and defense modernization dominate the NAPS portfolio. INTEL region accounts show the highest engagement density with multiple active procurement cycles. DEFENSE is consolidating vendor relationships across Army, Navy, and Air Force programs. CIVILIAN remains mixed — strong IRS and Federal Reserve activity but several unresolved identities limit coverage.",
        "group_briefs": {
            "_top": "Intelligence and defense modernization dominate the NAPS portfolio. INTEL region accounts show the highest engagement density with multiple active procurement cycles. DEFENSE is consolidating vendor relationships across Army, Navy, and Air Force programs. CIVILIAN remains mixed — strong IRS and Federal Reserve activity but several unresolved identities limit coverage.",
            "INTEL": "DIA and NSA are driving the bulk of INTEL engagement with active infrastructure modernization programs. Maryland Procurement Office is a key channel for contract vehicles. Booz Allen Hamilton IC identity remains ambiguous — manual resolution needed before next enrichment cycle.",
            "CIVILIAN": "IRS modernization is the standout opportunity in CIVILIAN, with strong meeting cadence and multiple open opportunities. Federal Reserve Board shows steady engagement. NIH and DEA identities are unresolved, creating a gap in coverage for healthcare and law enforcement territories.",
            "DEFENSE": "Army CECOM and General Dynamics are the most active DEFENSE accounts with increasing engagement trends. Naval Information Warfare Center shows strategic procurement activity. Kessel Run (USAF) is an emerging opportunity but L3Harris identity remains unresolved.",
            "FED_INTEL_ENT_POD_TERR01": "DIA and NSA both show strong engagement with active modernization programs. DIA has the higher signal density with 8 signals across infrastructure and security domains.",
            "FED_INTEL_ENT_POD_TERR03": "Maryland Procurement Office is the primary contracting channel. Owl Cyber Defense has niche security opportunities. Booz Allen identity is ambiguous — verify before next enrichment.",
            "FED_INTEL_ENT_POD_TERR05": "NGA is actively modernizing geospatial infrastructure with Red Hat involvement. Leidos Intelligence is a strong systems integrator partner in this space.",
            "FED_CIVILIAN_HEALTHCARE_ENT_POD_TERR03": "VA Health is the territory anchor with active cloud migration. CMS engagement is steady but lower priority. NIH identity not found — likely a naming mismatch in the registry.",
            "FED_CIVILIAN_FINANCIALS_ENT_POD_TERR08": "IRS modernization drives this territory with the highest meeting cadence in CIVILIAN. Federal Reserve and Treasury BFS are stable engagements. SEC identity is ambiguous.",
            "FED_CIVILIAN_LAW_ENFORCEMENT_AND_JUSTICE_ENT_POD_TERR06": "FBI shows consistent engagement across security and infrastructure. US Marshals is a secondary opportunity. DEA identity not found — registry name may need correction.",
            "FED_DEFENSE_ARMY_ENT_POD_TERR01": "CECOM and General Dynamics are the most active accounts with increasing trends. Lockheed Martin Rotary is a strong SI partner for Army modernization programs.",
            "FED_DEFENSE_NAVY_ENT_POD_TERR02": "NIWC is pursuing strategic infrastructure modernization with Red Hat. Raytheon Naval Systems is a key integrator for Navy programs.",
            "FED_DEFENSE_AIRFORCE_ENT_POD_TERR01": "Kessel Run is an emerging DevSecOps opportunity for USAF. Northrop Grumman Aeronautics has active engagements. L3Harris identity is unresolved — needs manual verification.",
        },
    },
    "accounts": accounts,
    "_meta": {
